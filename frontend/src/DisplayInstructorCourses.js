...
class DisplayInstructorCourses extends Component {
    ...
    async handleSubmit(event) {
        ...
        const response = await fetch('http://localhost:8080/api/query/instructor/' + item.net_id);
    ...
    render() {
        const {item} = this.state;
        const title = <h2>{'Display Courses By Instructor'}</h2>;
...
export default withRouter(DisplayInstructorCourses);